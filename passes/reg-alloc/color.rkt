...
;                (arg_fresh_3 : Integer)
;                (arg_fresh_4 : Integer)
;                (arg_fresh_5 : Integer)) : Integer
;        (movq (reg rbx) (var save_rbx__fresh_26))
;        (movq (reg r12) (var save_r12__fresh_27))
;        (movq (reg r13) (var save_r13__fresh_28))
;        (movq (reg r14) (var save_r14__fresh_29))
;        (movq (reg r15) (var save_r15__fresh_30))
;        (movq (reg rbp) (var save_rbp__fresh_31))
;        (movq (reg rdi) (var arg_fresh_0))
;        (movq (reg rsi) (var arg_fresh_1))
;        (movq (reg rdx) (var arg_fresh_2))
;        (movq (reg rcx) (var arg_fresh_3))
;        (movq (reg r8) (var arg_fresh_4))
;        (movq (reg r9) (var arg_fresh_5))
;        (movq (var arg_fresh_0) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_10))
;        (movq (var arg_fresh_1) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_11))
;        (movq (var arg_fresh_2) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_12))
;        (movq (var arg_fresh_3) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_13))
;        (movq (var arg_fresh_4) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_14))
;        (movq (var arg_fresh_5) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_15))
;        (movq (var funret_fresh_14) (var tmp_fresh_16))
;        (addq (var funret_fresh_15) (var tmp_fresh_16))
;        (movq (var tmp_fresh_16) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_17))
;        (movq (var funret_fresh_13) (var tmp_fresh_18))
;        (addq (var funret_fresh_17) (var tmp_fresh_18))
;        (movq (var tmp_fresh_18) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_19))
;        (movq (var funret_fresh_12) (var tmp_fresh_20))
;        (addq (var funret_fresh_19) (var tmp_fresh_20))
;        (movq (var tmp_fresh_20) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_21))
;        (movq (var funret_fresh_11) (var tmp_fresh_22))
;        (addq (var funret_fresh_21) (var tmp_fresh_22))
;        (movq (var tmp_fresh_22) (reg rdi))
;        (callq (toplevel-fn id))
;        (movq (reg rax) (var funret_fresh_23))
;        (movq (var funret_fresh_10) (var tmp_fresh_24))
;        (addq (var funret_fresh_23) (var tmp_fresh_24))
;        (movq (var tmp_fresh_24) (reg rax))
;        (movq (var save_rbx__fresh_26) (reg rbx))
;        (movq (var save_r12__fresh_27) (reg r12))
;        (movq (var save_r13__fresh_28) (reg r13))
;        (movq (var save_r14__fresh_29) (reg r14))
;        (movq (var save_r15__fresh_30) (reg r15))
;        (movq (var save_rbp__fresh_31) (reg rbp)))))
; 
; (pretty-print ((reg-alloc "") test-pgm))
